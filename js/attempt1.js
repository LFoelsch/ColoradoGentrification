...
function setMap(){
  ...
  var map = new L.map('map').setView([39.7, -104.99], 10)
  .addLayer(new L.TileLayer("data\RedlineMap.tif",
  {attribution: 'Stamen'}
));
...
d3.json("data/COtracts.json", function(error, jsonData) {
...
pcpdata.push(d.properties);
  ...
  function highlight(data){
    ...
    var labelAttribute = "<h1>"+ roundRight(props[expressed]) + "%</h1><br><b> " + expressed + "</b>:" + props[key]+ ""; //label content
